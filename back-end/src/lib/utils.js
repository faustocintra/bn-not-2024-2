/*Função que processa a query string da requisição e verifica se o parâmetro include
foi passado. Caso positivo, preenche um objetivo com os relacionamentos que devem ser
incluidos na consulta sendo executada.
*/
