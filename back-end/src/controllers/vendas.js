...
controller.retrieveOne = async function (req, res) {
    try {
        ...
        // Não encotrou o documento ~> retorna o HTTP 404: Not Found
...
controller.update = async function (req, res) {
    try {
        ...
        // o documento seja encontrado, atualiza-lo com as informações
        // passadas em red.body
...
controller.createItem = async function (req, res) {
    try{
        ...
        // passando como parâmetro na rota
...
controller.retrieveOneItem = async function (req, res) {
    try{
        ...
        const result = prisma.itemVenda.findFirst({
            where: {
