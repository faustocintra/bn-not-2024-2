...
controller.retrieveOneItem = async function (req, res) {
  try {
    ...
    // A rigo, item da venda poderia ser encontrado apenas, por
    // seu id. No entrando para forlar a necessidade da assocuação
    // de um item de venda a venda correspodnente, a bbisca e feita
    // usando-se tanto o id do item da venda qyabto o id da venda
