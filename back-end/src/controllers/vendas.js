...
controller.retrieveOneItem = async function(req, res) {
    try{
        // A rigor, o item da venda poderia ser encontrado apenas por seu id. No entanto,
        // para forçar a necessidade da associação de um item de venda à venda correspondente,
        // a busca é feita usando-se tanto o id do item da venda quanto o id da venda
