...
controller.create = async function (req, res) {
    try {
        /*
        Conecta-se ao BD e envia uma instrução de criação de
        um novo documento, com os dados que estão dentro de req.body
        */
...
controller.update = async function (req, res) {
    try {
        ...
        // Encontrou e atualizou ~> retorn HTTP 204: No Content
